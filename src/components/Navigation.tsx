...
export default function Navigation() {
  ...
  const authLinks = [
    ...
    { to: '/repeat-medicine', icon: Repeat2, label: t('repeat_medicine.title', 'Repeat Medicine / Receive Pending'), subLabel: t('repeat_medicine.menu_hint', 'Repeat medicines or collect old dues'), roles: ['MED', 'med', 'medical'] },
